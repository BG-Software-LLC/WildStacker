package com.bgsoftware.wildstacker.nms.v1_18_R2.mappings.net.minecraft.world.entity;
...
import com.bgsoftware.wildstacker.nms.v1_18_R2.mappings.net.minecraft.world.phys.AxisAlignedBB;
...
public class Entity extends MappedObject<net.minecraft.world.entity.Entity> {
    ...
    public boolean isNoAI() {
        return ((EntityInsentient) handle).fs();
    }
    ...
    public float[] getArmorDropChances() {
        return ((EntityInsentient) handle).bT;
    }
...
//        ((EntityLiving) handle).d(itemSlot);
    ...
    public BehaviorController<EntityPiglin> getBrain() {
        return new BehaviorController<>(((EntityPiglin) handle).du());
    }
    ...
    public SaddleStorage getSaddleStorage() {
        return new SaddleStorage(((EntityStrider) handle).ce);
    }
    ...
    public VillagerData getVillagerData() {
        return ((EntityVillager) handle).fK();
    }
    ...
    public Reputation getGossips() {
        return ((EntityVillager) handle).fW();
    }
    ...
    public MerchantRecipeList getOffers() {
        return ((EntityVillagerAbstract) handle).fB();
    }
