...
public final class NMSMappings_v1_19_R1 {
    ...
    public static ItemStack getItemBySlot(EntityLiving entityLiving, EnumItemSlot enumItemSlot) {
        return entityLiving.c(enumItemSlot);
    }
