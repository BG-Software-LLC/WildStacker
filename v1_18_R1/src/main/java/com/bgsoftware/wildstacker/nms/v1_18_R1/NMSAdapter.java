...
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.resources.MinecraftKey;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.server.level.ChunkProviderServer;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.server.level.MobSpawnerData;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.tags.Tag;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.entity.Entity;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.entity.SaddleStorage;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.entity.ai.BehaviorController;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.item.Item;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.item.ItemStack;
...
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.level.block.state.IBlockData;
...
public final class NMSAdapter implements com.bgsoftware.wildstacker.nms.NMSAdapter {
    ...
    private static final ReflectMethod<Boolean> IS_DROP_EXPERIENCE = new ReflectMethod<>(EntityLiving.class, boolean.class, "dH");
    ...
    private static final ReflectMethod<net.minecraft.core.BlockPosition> TURTLE_HOME_POS = new ReflectMethod<>(EntityTurtle.class, "fz");
    ...
    @Remap(classPath = "net.minecraft.tags.ItemTags", name = "PIGLIN_LOVED", type = Remap.Type.FIELD, remappedName = "O")
    private static final Tag<net.minecraft.world.item.Item> PIGLIN_LOVED_TAG = new Tag<>(TagsItem.O);
    ...
    public boolean handlePiglinPickup(org.bukkit.entity.Entity bukkitPiglin, org.bukkit.entity.Item bukkitItem) {
        ...
        if (PIGLIN_LOVED_TAG.contains(item.getHandle())) {
