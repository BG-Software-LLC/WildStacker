...
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.core.BlockPosition;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.nbt.NBTTagCompound;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.server.level.MobSpawnerData;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.entity.Entity;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.level.ChunkCoordIntPair;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.level.World;
import com.bgsoftware.wildstacker.nms.v1_18_R1.mappings.net.minecraft.world.level.block.entity.TileEntity;
...
public final class NMSSpawners implements com.bgsoftware.wildstacker.nms.NMSSpawners {
    ...
    private static final net.minecraft.tags.Tag.e<Block> AXOLOTLS_SPAWNABLE_ON_TAG = TagsBlock.bt;
    @Remap(classPath = "net.minecraft.tags.BlockTags", name = "FOXES_SPAWNABLE_ON", type = Remap.Type.FIELD, remappedName = "bz")
    private static final net.minecraft.tags.Tag.e<Block> FOXES_SPAWNABLE_ON_TAG = TagsBlock.bz;
    @Remap(classPath = "net.minecraft.tags.BlockTags", name = "GOATS_SPAWNABLE_ON", type = Remap.Type.FIELD, remappedName = "bu")
    private static final net.minecraft.tags.Tag.e<Block> GOATS_SPAWNABLE_ON_TAG = TagsBlock.bu;
    @Remap(classPath = "net.minecraft.tags.BlockTags", name = "RABBITS_SPAWNABLE_ON", type = Remap.Type.FIELD, remappedName = "by")
    private static final net.minecraft.tags.Tag.e<Block> RABBITS_SPAWNABLE_ON_TAG = TagsBlock.by;
    @Remap(classPath = "net.minecraft.tags.BlockTags", name = "LEAVES", type = Remap.Type.FIELD, remappedName = "I")
    private static final net.minecraft.tags.Tag.e<Block> LEAVES_TAG = TagsBlock.I;
    @Remap(classPath = "net.minecraft.tags.BlockTags", name = "LOGS", type = Remap.Type.FIELD, remappedName = "s")
    private static final net.minecraft.tags.Tag.e<Block> LOGS_TAG = TagsBlock.s;
    ...
    public void registerSpawnConditions() {
        ...
        createCondition("ANIMAL_LIGHT_AND_COLD", (world, position) -> {
            Optional<ResourceKey<BiomeBase>> biomeBase = world.getBiome(position.getHandle());
            boolean coldBiome = Objects.equals(biomeBase, Optional.of(FROZEN_OCEAN_BIOME)) ||
                    Objects.equals(biomeBase, Optional.of(DEEP_FROZEN_OCEAN_BIOME));
        ...
        createCondition("IN_SLIME_CHUNK_OR_SWAMP", (world, position) -> {
            ...
            if (Objects.equals(biomeBase, Optional.of(SWAMP_BIOME)))
                return true;

            ChunkCoordIntPair chunkcoordintpair = new ChunkCoordIntPair(position.getHandle());
            boolean isSlimeChunk = SeededRandom.a(chunkcoordintpair.getX(), chunkcoordintpair.getZ(), ((GeneratorAccessSeed) world.getHandle()).E(),
        ...
        createCondition("IN_FISH_WATER_OR_LUSH_CAVES",
                (world, position) -> world.getFluidState(position.below()).a(TagsFluid.b) &&
                        (Objects.equals(world.getBiome(position.getHandle()), Optional.of(LUSH_CAVES_BIOME)) ||
                                (world.getBlockState(position.above()).getHandle().a(WATER_BLOCK) &&
                                        position.getY() >= world.getSeaLevel() - 13 && position.getY() <= world.getSeaLevel())),
        ...
        createCondition("NOT_IN_OCEAN", (world, position) -> {
            Optional<ResourceKey<BiomeBase>> biomeBase = world.getBiome(position.getHandle());
            return !Objects.equals(biomeBase, Optional.of(OCEAN_BIOME)) &&
                    !Objects.equals(biomeBase, Optional.of(DEEP_OCEAN_BIOME));
        }, EntityType.DOLPHIN);

        createCondition("IN_RIVER", (world, position) -> {
            Optional<ResourceKey<BiomeBase>> biomeBase = world.getBiome(position.getHandle());
            return !Objects.equals(biomeBase, Optional.of(RIVER_BIOME)) &&
                    !Objects.equals(biomeBase, Optional.of(FROZEN_RIVER_BIOME));
        }, EntityType.DOLPHIN);
