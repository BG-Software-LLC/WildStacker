...
public final class NMSSpawners_v1_18_R1 implements NMSSpawners {
    ...
    public void registerSpawnConditions() {
        ...
        createCondition("IN_LAVA_AND_AIR_ABOVE", (world, position) -> {
            ...
            } while (getFluid(world, mutableBlockPosition).a(TagsFluid.c));
        ...
        createCondition("IN_SLIME_CHUNK_OR_SWAMP", (world, position) -> {
            if (Objects.equals(world.i(position), Optional.of(Biomes.g)))
                return true;

            ChunkCoordIntPair chunkcoordintpair = new ChunkCoordIntPair(position);
            boolean isSlimeChunk = SeededRandom.a(chunkcoordintpair.c, chunkcoordintpair.d, ((GeneratorAccessSeed) world).E(),
        ...
        createCondition("IN_FISH_WATER_OR_LUSH_CAVES",
                (world, position) -> getFluid(world, position.c()).a(TagsFluid.b) &&
                        (Objects.equals(world.i(position), Optional.of(Biomes.Y)) ||
        ...
        createCondition("IN_RIVER", (world, position) -> {
            Optional<ResourceKey<BiomeBase>> biomeBase = world.i(position);
            return Objects.equals(biomeBase, Optional.of(Biomes.I)) || Objects.equals(biomeBase, Optional.of(Biomes.J));
        }, EntityType.DOLPHIN);
    ...
    static class StackedMobSpawner extends MobSpawnerAbstract {
        ...
        private boolean handleEntitySpawn(WorldServer world, BlockPosition position,
            ...
            if (entity instanceof EntityInsentient entityInsentient) {
                if (getEntity(this.e).e() == 1 && hasKeyOfType(getEntity(this.e), "id", 8)) {
                    prepare((EntityInsentient) entity, world, getDamageScaler(world, getChunkCoordinates(entity)),
            ...
            if (CraftEventFactory.callSpawnerSpawnEvent(entity, position).isCancelled()) {
                ...
                if (entity instanceof EntityInsentient) {
                    doSpawnEffect((EntityInsentient) entity);
                }
        ...
        private boolean addEntity(World world, Entity entity) {
            ...
            if (NMSMappings_v1_18_R1.addEntity(world, entity, CreatureSpawnEvent.SpawnReason.SPAWNER)) {
