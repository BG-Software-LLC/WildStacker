...
public final class NMSAdapter_v1_18_R1 implements NMSAdapter {
    ...
    private static final ReflectMethod<BlockPosition> TURTLE_HOME_POS = new ReflectMethod<>(EntityTurtle.class, "fz");
    ...
    public boolean handleEquipmentPickup(LivingEntity livingEntity, Item bukkitItem) {
        ...
        ItemStack equipmentItem = getEquipment(entityInsentient, equipmentSlotForItem);

        double equipmentDropChance = entityInsentient.bU[equipmentSlotForItem.b()];
        ...
        setSlot(entityInsentient, equipmentSlotForItem, itemStack);
