...
public final class EntityHelper_v1_8_R2 {
    ...
    static net.minecraft.server.v1_8_R2.Entity createEntity(Location location, Class<? extends Entity> clazz) throws IllegalArgumentException {
        if (location != null && clazz != null) {
            World world = ((CraftWorld) location.getWorld()).getHandle();
            net.minecraft.server.v1_8_R2.Entity entity = null;
    ...
    static void addEntity(net.minecraft.server.v1_8_R2.Entity entity, CreatureSpawnEvent.SpawnReason reason) throws IllegalArgumentException {
        if(entity == null)
