...
import net.minecraft.server.v1_11_R1.UtilColor;
...
public final class NMSSpawners_v1_11_R1 implements NMSSpawners {
    ...
    public void registerSpawnConditions() {
        createCondition("ANIMAL_LIGHT",
                ...
                EntityType.MUSHROOM_COW, EntityType.MULE, EntityType.PIG, EntityType.RABBIT,
        ...
        createCondition("IN_SLIME_CHUNK",
                (world, position) -> world.getChunkAtWorldCoords(position).a(987234911L)
                        .nextInt(10) == 0 && world.random.nextInt(10) == 0 && position.getY() < 40,
                EntityType.SLIME
        );

        createCondition("IN_SWAMP",
                (world, position) -> world.getBiome(position) == Biomes.h,
                EntityType.SLIME
        );
        ...
        createCondition("MONSTER_LIGHT", (world, position) -> {
            if (world.getBrightness(EnumSkyBlock.SKY, position) > world.random.nextInt(32)) {
                ...
                EntityType.ZOMBIE_VILLAGER, EntityType.EVOKER, EntityType.VEX, EntityType.VINDICATOR
        );
        ...
        createCondition("NOT_PEACEFUL",
                ...
                EntityType.VEX, EntityType.VINDICATOR, EntityType.ELDER_GUARDIAN
        );
