        ...
        public void e() {
            ...
            try {
                ...
                if (b >= 60 && animal.h(partner) < 9.0D){
                    xyz.wildseries.wildstacker.listeners.events.EntityBreedEvent event = new EntityBreedEvent((LivingEntity) animal.getBukkitEntity(), (LivingEntity) partner.getBukkitEntity());
