package com.bgsoftware.wildstacker.nms.v1194;
...
public class NMSWorld implements com.bgsoftware.wildstacker.nms.NMSWorld {
    ...
    private static final ReflectMethod<Boolean> RAIDER_CAN_RAID = new ReflectMethod<>(Raider.class, boolean.class, "gh");
    private static final ReflectMethod<Raid> RAIDER_RAID = new ReflectMethod<>(Raider.class, Raid.class, "gg");
