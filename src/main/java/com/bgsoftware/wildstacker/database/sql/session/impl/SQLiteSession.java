package com.bgsoftware.wildstacker.database.sql.session.impl;
...
import com.bgsoftware.wildstacker.logging.Debug;
...
public class SQLiteSession implements SQLSession {
    ...
    public SQLiteSession(WildStackerPlugin plugin, boolean logging) {
        this.plugin = plugin;
