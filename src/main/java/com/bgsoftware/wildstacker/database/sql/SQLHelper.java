package com.bgsoftware.wildstacker.database.sql;


import com.bgsoftware.wildstacker.WildStackerPlugin;
import com.bgsoftware.wildstacker.api.data.DatabaseFilter;
import com.bgsoftware.wildstacker.api.objects.Pair;
import com.bgsoftware.wildstacker.database.sql.session.QueryResult;
import com.bgsoftware.wildstacker.database.sql.session.SQLSession;
import com.bgsoftware.wildstacker.database.sql.session.impl.MariaDBSession;
import com.bgsoftware.wildstacker.database.sql.session.impl.MySQLSession;
import com.bgsoftware.wildstacker.database.sql.session.impl.SQLiteSession;
...
public class SQLHelper {
    ...
    public static SQLSession createSession(WildStackerPlugin plugin, boolean logging) {
