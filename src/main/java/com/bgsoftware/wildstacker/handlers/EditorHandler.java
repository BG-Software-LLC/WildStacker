...
public final class EditorHandler {
    ...
    public final static String SPAWNERS_SLOT_0 = "spawners.enabled", SPAWNERS_SLOT_1 = "spawners.merge-radius",
            ...
            SPAWNERS_SLOT_16 = "spawners.silk-spawners.explosions-drop-spawner", SPAWNERS_SLOT_17 = "spawners.silk-spawners.drop-to-inventory",
            SPAWNERS_SLOT_18 = "spawners.shift-get-whole-stack", SPAWNERS_SLOT_19 = "spawners.get-stacked-item",
            SPAWNERS_SLOT_20 = "spawners.floating-names", SPAWNERS_SLOT_21 = "spawners.break-menu.enabled",
            SPAWNERS_SLOT_22 = "spawners.place-inventory", SPAWNERS_SLOT_23 = "spawners.placement-permission",
            SPAWNERS_SLOT_24 = "spawners.shift-place-stack", SPAWNERS_SLOT_25 = "spawners.break-charge.amount",
            SPAWNERS_SLOT_26 = "spawners.break-charge.multiply-stack-amount", SPAWNERS_SLOT_27 = "spawners.place-charge.amount",
            SPAWNERS_SLOT_28 = "spawners.place-charge.multiply-stack-amount", SPAWNERS_SLOT_29 = "spawners.change-using-eggs",
            SPAWNERS_SLOT_30 = "spawners.eggs-stack-multiply", SPAWNERS_SLOT_31 = "spawners.next-spawner-placement",
            SPAWNERS_SLOT_32 = "spawners.only-one-spawner";
    ...
    private void buildInventory(Inventory inventory, Set<Field> fields, String pathPrefix){
        for(Field field : fields){
            ...
            ItemBuilder itemBuilder = new ItemBuilder(Materials.CLOCK).withName("&6" + getFormattedName(path.replace(pathPrefix, "")));
