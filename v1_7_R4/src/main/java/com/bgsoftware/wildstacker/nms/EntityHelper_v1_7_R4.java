...
public final class EntityHelper_v1_7_R4 {

    static net.minecraft.server.v1_7_R4.Entity createEntity(Location location, Class<? extends Entity> clazz) throws IllegalArgumentException {
