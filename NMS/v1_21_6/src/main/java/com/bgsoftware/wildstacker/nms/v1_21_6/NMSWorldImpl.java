...
public class NMSWorldImpl implements NMSWorld {
    ...
    private static final ReflectMethod<Boolean> RAIDER_HAS_ACTIVE_RAID = new ReflectMethod<>(Raider.class, boolean.class, "gX");
    private static final ReflectMethod<Raid> RAIDER_GET_CURRENT_RAID = new ReflectMethod<>(Raider.class, Raid.class, "gU");
